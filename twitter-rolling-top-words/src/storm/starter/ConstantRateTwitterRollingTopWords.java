...
import storm.starter.spout.ConstantRateTweetReader;
 ...
 */
public class ConstantRateTwitterRollingTopWords {

  private static final Logger logger = Logger.getLogger(ConstantRateTwitterRollingTopWords.class);
  ...
  public ConstantRateTwitterRollingTopWords(String topologyName, Parameters parameters) throws InterruptedException {
  ...
  private void wireTopology() throws InterruptedException {
	  ...
	  builder.setSpout(TWEET_READER_ID, 
			  new ConstantRateTweetReader(parameters.batchTupleCount, parameters.batchLength, parameters.ackerCount > 0, parameters.logThroughput, parameters.logLatency), 
  ...
  public static void main(String[] args) throws Exception {
	...
	ConstantRateTwitterRollingTopWords rtw = new ConstantRateTwitterRollingTopWords("twitter-top-words", parameters);
	if (parameters.local) {
