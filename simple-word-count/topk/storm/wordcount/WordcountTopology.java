...
public class WordcountTopology {
	...
	private StormTopology createTopology() {
		...
		builder.setBolt(COUNTER_ID, new Counter(parameters.K, parameters.secondsToSendCounters), parameters.counterReplication).fieldsGrouping(FILTER_ID, new Fields("word"));
		
		builder.setBolt(SINK_ID, new Sink(parameters.K, parameters.sinkFolder, parameters.secondsToSink)).shuffleGrouping(COUNTER_ID);
